...
image1 = im2single(imread('../data/sneakers.jpg'));
image2 = im2single(imread('../data/smile.jpg'));
...
imwrite(image1, 'Q4_2_image1.jpg', 'quality', 95);
imwrite(image2, 'Q4_2_image2.jpg', 'quality', 95);
...
imwrite(new_image1, 'Q4_2_new_image1.jpg', 'quality', 95);
imwrite(new_image2, 'Q4_2_new_image2.jpg', 'quality', 95);
...
imwrite(low_freq, 'Q4_2_low_freq.jpg', 'quality', 95);
imwrite(high_freq, 'Q4_2_high_freq.jpg', 'quality', 95);
imwrite(hybrid, 'Q4_2_hrbrid.jpg', 'quality', 95);
imwrite(vis, 'Q4_2_hybrid_scales.jpg', 'quality', 95);
